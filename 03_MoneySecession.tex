...
Sound impossible? Does the idea of writing and performing plays with
...
The way to mitigate against this possibility is to encourage local businesses, 
hyper-local businesses, and microbusinesses within the economy.  If an economy \textit{depends}
...
local small businesses, especially those doing business \textit{with} the 
local community, communities can better build up 
an internal robustness which will shield the community against unforseen outside problems.
...
\begin{itemize}
\item 
\textit{The Total Money Makeover} by Dave Ramsey.  Dave Ramsey is a great source of practical wisdom 
