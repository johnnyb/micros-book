...
agriculture companies are going to sell the food to you for your inflated money
...
Hopefully, we won’t have to depend on this. But if we do, it is good to be prepared. 

\section{Food Storage}

We will discuss three ways in which we can secede from the
national food supply.
The first, which I believe is most important, is food storage. To show
you why this is so important, let me
...
point. However, it seems they left all of the concerns of saving and storing
...
was only one problem. When tough times come, those who have resources usually use
those resources as a power grab against those who don’t.

What happened to the people of Egypt during this time? Well, at first, they
...
Pharaoh was able to enslave the whole nation because he was better
...
you have---even your home---for food. The point of preparing is so
that in a sticky situation we won’t be the ones who will suffer and can
...
But this isn’t necessarily the case. A lot of foods will store for a very
...
many sources, the easiest of which is the rain. Many gardening
...
the ability to slow down to your garden’s pace and submitting yourself
to nature's seasons and rhythm is good for your soul.
...
fast.  As you get more used to the way nature works, you can branch out
to try more difficult plants, and grow your patience as well as your food.
...
leafy vegetables can even be cut several times before replanting, though the
...
garnishes when you thin them out.  To do this well you will need to 
buy your seeds in bulk, but you should do that anyway.  The price 
for individual seed packets is rediculous---a one pound bag of seed
usually costs the same as five seed packets, and will probably last you
years.
...
that much food (especially if you don't live in California), 
but this lets you know how far you can take it. Most of
us mere mortals probably get about a half a pound of produce per square
foot, which is about a third of what
the Dervaeses are producing.
...
and can also be used for meat if necessary (our children won’t let me use
...
Even if you have no garden prepared, no space set aside, no nothing, I am
...
just a few days. Growing them is simple. First, you need to build a sprouter
...
allows us to add and remove water very easily without losing our seeds 
and plants. From this point, every
...
enough air to grow and will mold. 
...
couldn’t have ten chickens without problems. A single dog eats more food,
...
get most of their food in the wild from
non-cultivated plants. We have developed agriculture to increase the abundance and taste of edible food, but it is good to
...
ally. Food is not a special manmade add-on to nature. Food exists
...
things as well, such as rope
and building materials. When we open our eyes, we can see that as long
as there are growing plants and we have our freedom, we can never be
truly poor.
...
dandelions aren’t even native to North America. They were intentionally brought here
...
food, largely done in the name of public health. While there are things
that really are public health concerns, most ``public health'' issues
...
you don’t eat, rather than the yolks, which you do. Although we have
...
almost as dangerous as heroin, given the way the government treats
...
commercial food production to the mega-companies who can afford to comply. 
One of the easiest sources of income for people who are in a tight bind is to grow,
...
impoverished families grow to independence.
...
actually happening, not just hyped-up ambiguous fears.  In addition,
