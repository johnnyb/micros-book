...
guide to small-scale farming.  %% FIXME - need more description
\item 
\textit{Pay Dirt: How to Make \$10,000 a Year from Your Backyard Garden} by John Tullock.
We are used to seeing our gardens as being only for us and our family.  This book shows how
to use your yard as an income stream.  If you are going to convert from consumption to production,
...
%% FIXME - http://lds.about.com/library/bl/faq/blcalculator.htm
\end{itemize}
